...
## Table 15 -- I'm sleepy so some of the numbers might be wrong
ZDA_MODEL['BARE-AC-B'] = dict()
ZDA_MODEL['BARE-AC-B']['PAH'] = [4.47594e-7, 3.5e-4, 3.7e-3, -9.1238, \
    [-3.78439, 6.02165e5, 0.0, 1.e24, 0.0], \
    [1.0, 1.0, 1.0, 1.76358e-3, 1.0], \
    [1.0, -14.3958, 0.0, 8.85147, 0.0]]
ZDA_MODEL['BARE-AC-B']['ACH2'] = [7.813825e-12, 0.02, 0.25, -3.79483, \
    [-3.46375, 3.41188e-17, 0.0, 0.0, 0.0], \
    [1.0, 1.94208e-4, 1.0, 1.0, 1.0], \
    [1.0, 34.2285, 0.0, 0.0, 0.0]]
ZDA_MODEL['BARE-AC-B']['Silicate1'] = [3.157991e-7, 3.5e-4, 0.03, -8.95818, \
    [-3.71928, 4.01642e-14, 0.0, 0.0, 0.0], \
    [1.0, 2.45908e-6, 1.0, 1.0, 1.0], \
    [1.0, 22.8203, 0.0, 0.0, 0.0]]
ZDA_MODEL['BARE-AC-B']['Silicate2'] = [8.130755e-13, 0.021, 0.33, 2.2829e-2, \
    [2.38667e4, 1.4412e4, 5.12554e2, 0.0, 0.0], \
    [1.0, 1.44139e4, 7.85859e-2, 1.0, 1.0], \
    [1.0, 1.00016, 10.2469, 0.0, 0.0]]
